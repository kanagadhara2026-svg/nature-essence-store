  ...
  return (
    <div className="group cursor-pointer card-3d-hover rounded-2xl overflow-hidden">
      ...
      <div className="relative overflow-hidden aspect-square">
        ...
        {isNew && (
          <span className="absolute top-3 left-3 bg-primary/90 backdrop-blur-sm text-primary-foreground text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider">
            New
          </span>
        )}

        {originalPrice && (
          <span className="absolute top-3 right-3 bg-accent/90 backdrop-blur-sm text-accent-foreground text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider">
            Sale
          </span>
        )}
      ...
      <div className="p-4">
        ...
        <h3 className="font-serif text-base sm:text-lg font-semibold text-foreground mb-2 group-hover:text-gradient transition-all line-clamp-1">
          {name}
        </h3>
